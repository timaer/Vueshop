...
export default {
   ...
   computed:{
      ...
      dashtotal(){
          return this.$store.getters.checkeddashtotal()
      },
      realtotal(){
          return this.$store.getters.checkedcarttotal(this.$store.state.shop.clicked,true)
      },
      discount(){
          return this.$store.getters.checkedcartdiscount()
      },
      cartlist(){
          return this.$store.getters.checkedcart()
      }
   },
   created(){
      this.getList()
   ...
   methods: {
      ...
      onSubmit(){
            ...
            let orderinfo=[]
            orderinfo["shopid"]=this.$store.getters.fromshopid
            orderinfo['goodslist']=this.$store.getters.checkedcart()
